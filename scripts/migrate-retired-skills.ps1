...
# v7.0.0: obsidian-vault, teach, edit-article, grill-me, setup-matt-pocock-skills (removed)
...
$retiredSkills   = @('zoom-out', 'caveman', 'write-a-skill', 'diagnose',   # diagnose -> diagnosing-bugs
                     ...
                     'setup-matt-pocock-skills', 'design-workflow')        # design-workflow -> merged into design (v7.0.0)
