...
$matrix = @(
    ...
    @{ Id='skill:diagnose';                       Claude='templates/claude/.claude/skills/diagnose.md';                       Codex='templates/codex/.Codex/skills/diagnose.md';                       OpenCode='templates/opencode/.opencode/skills/diagnose/SKILL.md' }
    @{ Id='skill:grill-with-docs';                Claude='templates/claude/.claude/skills/grill-with-docs.md';                Codex='templates/codex/.Codex/skills/grill-with-docs.md';                OpenCode='templates/opencode/.opencode/skills/grill-with-docs/SKILL.md' }
    @{ Id='skill:improve-codebase-architecture';  Claude='templates/claude/.claude/skills/improve-codebase-architecture.md';  Codex='templates/codex/.Codex/skills/improve-codebase-architecture.md';  OpenCode='templates/opencode/.opencode/skills/improve-codebase-architecture/SKILL.md' }
    @{ Id='skill:roundtable';                     Claude='templates/claude/.claude/skills/roundtable.md';                     Codex='templates/codex/.Codex/skills/roundtable.md';                     OpenCode='templates/opencode/.opencode/skills/roundtable/SKILL.md' }
    @{ Id='skill:tdd';                            Claude='templates/claude/.claude/skills/tdd.md';                            Codex='templates/codex/.Codex/skills/tdd.md';                            OpenCode='templates/opencode/.opencode/skills/tdd/SKILL.md' }
    @{ Id='skill:to-issues';                      Claude='templates/claude/.claude/skills/to-issues.md';                      Codex='templates/codex/.Codex/skills/to-issues.md';                      OpenCode='templates/opencode/.opencode/skills/to-issues/SKILL.md' }
    @{ Id='skill:to-prd';                         Claude='templates/claude/.claude/skills/to-prd.md';                         Codex='templates/codex/.Codex/skills/to-prd.md';                         OpenCode='templates/opencode/.opencode/skills/to-prd/SKILL.md' }
    ...
    @{ Id='overlay:myst/design';                  Claude='overlays/myst-project/.claude/skills/design.md';                   Codex='overlays/myst-project/.Codex/skills/design.md';                   OpenCode='overlays/myst-project/.opencode/skills/design/SKILL.md' }
