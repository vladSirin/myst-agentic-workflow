...
$matrix = @(
    ...
    # Phase B-2: restored companions for converged carried skills (three-way)
    @{ Id='skill:triage/AGENT-BRIEF'; Claude='templates/claude/.claude/skills/triage/AGENT-BRIEF.md'; Codex='templates/codex/.Codex/skills/triage/AGENT-BRIEF.md'; OpenCode='templates/opencode/.opencode/skills/triage/AGENT-BRIEF.md' }
    @{ Id='skill:triage/OUT-OF-SCOPE'; Claude='templates/claude/.claude/skills/triage/OUT-OF-SCOPE.md'; Codex='templates/codex/.Codex/skills/triage/OUT-OF-SCOPE.md'; OpenCode='templates/opencode/.opencode/skills/triage/OUT-OF-SCOPE.md' }
    @{ Id='skill:tdd/mocking'; Claude='templates/claude/.claude/skills/tdd/mocking.md'; Codex='templates/codex/.Codex/skills/tdd/mocking.md'; OpenCode='templates/opencode/.opencode/skills/tdd/mocking.md' }
    @{ Id='skill:tdd/refactoring'; Claude='templates/claude/.claude/skills/tdd/refactoring.md'; Codex='templates/codex/.Codex/skills/tdd/refactoring.md'; OpenCode='templates/opencode/.opencode/skills/tdd/refactoring.md' }
    @{ Id='skill:tdd/tests'; Claude='templates/claude/.claude/skills/tdd/tests.md'; Codex='templates/codex/.Codex/skills/tdd/tests.md'; OpenCode='templates/opencode/.opencode/skills/tdd/tests.md' }
    @{ Id='skill:improve-codebase-architecture/HTML-REPORT'; Claude='templates/claude/.claude/skills/improve-codebase-architecture/HTML-REPORT.md'; Codex='templates/codex/.Codex/skills/improve-codebase-architecture/HTML-REPORT.md'; OpenCode='templates/opencode/.opencode/skills/improve-codebase-architecture/HTML-REPORT.md' }
    ...
    @{ Id='skill:roundtable';                     Claude='overlays/core-local/.claude/skills/roundtable/SKILL.md';                     Codex='overlays/core-local/.Codex/skills/roundtable/SKILL.md';                     OpenCode='overlays/core-local/.opencode/skills/roundtable/SKILL.md' }
    @{ Id='skill:setup-agentic-workflow';            Claude='overlays/core-local/.claude/skills/setup-agentic-workflow/SKILL.md';     Codex='overlays/core-local/.Codex/skills/setup-agentic-workflow/SKILL.md';     OpenCode='overlays/core-local/.opencode/skills/setup-agentic-workflow/SKILL.md' }
