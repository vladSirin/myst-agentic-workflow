...
$pkgFile = Join-Path $pkg 'templates\claude\.claude\skills\diagnose.md'
...
Restore-PackageFile 'templates/claude/.claude/skills/diagnose.md'
Remove-Item -Recurse -Force $t -ErrorAction SilentlyContinue
