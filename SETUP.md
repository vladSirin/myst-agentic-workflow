...
| **Dev kit** | `myst-dev-kit` plugin / `setup-devkit.ps1` (this repo) | 24 skills, the two reviewer agents (Claude native; generated for Codex + OpenCode — see below), `sync-build-submit` + package commands, the Submit-Audit warning bridge (Codex; verified firing 2026-08-06) |
