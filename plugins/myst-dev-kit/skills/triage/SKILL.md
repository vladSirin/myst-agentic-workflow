...
These are canonical role names. The actual label strings used in the issue tracker may differ. The mapping should have been provided to you. If not, ask the user where the project's triage-labels doc lives (a starter template ships in this package's `reference/`).
