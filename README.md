...
[![tests](https://img.shields.io/badge/tests-95%2F95-brightgreen)](#) [![version](https://img.shields.io/badge/version-v1.4.1-blue)](https://github.com/vladSirin/myst-agentic-workflow/releases) [![license](https://img.shields.io/badge/license-MIT-green)](LICENSE)
...
**v1.4.1** — full intro README with the six pain points the package solves, skill/workflow/overlay reference, FAQ, and known gotchas. Mirrors the structure of [mattpocock/skills](https://github.com/mattpocock/skills) for familiarity. Docs-only — no code changes. 95/95 tests across 10 suites.
